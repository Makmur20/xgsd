...
-- AddForeignKey
ALTER TABLE "RoomAmenities" ADD CONSTRAINT "RoomAmenities_ameniriesId_fkey" FOREIGN KEY ("ameniriesId") REFERENCES "Amenities"("id") ON DELETE CASCADE ON UPDATE CASCADE;
